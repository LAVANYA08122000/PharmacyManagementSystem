...
<body style="background: #ECF0F5;padding:0;margin:0">
  ...
  <tr>
    <td colspan="3" style="text-align: right;">Discount</td><th style="border-bottom: 1px solid blue;"><?php echo $total*0.1; ?></th>
  </tr>
  <tr>
    <td colspan="3" style="text-align: right;border-right: 1px solid blue">Gross Total</td><th style="border: 1px solid blue;"><?php echo $total-($total*0.1); ?></th>
  </tr>
  <tr>
...
$discount=$total*0.1;
    if (!$con->query("insert into sold (name,contact,discount,amount,item,userId) values ('$_POST[name]','$_POST[contact]','$discount','$total','$i','$_SESSION[userId]')")) 
    {
